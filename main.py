...
extract_audio("test_short.mp4", "test_short.wav")
video_duration = VideoFileClip("test.mov").duration

model = whisper.load_model("base")
result = model.transcribe("test.wav", task="translate")
...
for seg in result["segments"]:
    ...
    seg_tts = tts.tts_to_file(
        ...
        file_path=f'tts/test_{seg["id"]}.wav',
    )
    tts_list.append((seg["start"], seg["end"], f'tts/test_{seg["id"]}.wav'))
...
final_clip.write_videofile("test_replaced_audio.mp4", audio_codec="aac")
